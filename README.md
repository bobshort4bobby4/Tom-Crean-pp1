...
<details>
  ...
  * I had a problem with the page not scrolling fully down on the links page.  On the other pages I had set the height property to auto which works fine, however it does not on the links page and I do not understand why. I finally set different heights in the `grid-template-rows` property for various break points. I have tested this in a broad range of device types in the Google Chrome phone emulator, and it displays correctly in any I have tested. 
